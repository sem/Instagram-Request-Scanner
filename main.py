...
class P_InstagramAPI:
    ...
    DEVICE_SETTINTS = {'manufacturer': 'Xiaomi',
                       ...
                       'android_version': 19,
                       'android_release': '6.4'}
    USER_AGENT = 'Instagram 89.0.0.21.101 Android ({android_version}/{android_release}; 320dpi; 720x1280; {manufacturer}; {model}; armani; qcom; fr_FR)'.format(
        **DEVICE_SETTINTS)
    ...
    def SendRequest(self, endpoint, post=None, login=False, wait=20):
        ...
        if response.status_code == 200:
            ...
            return response.status_code, self.LastJson
        else:
